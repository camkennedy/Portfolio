...
|:-|:-|:-|
|**Russian Tweet Prediction**<br>Natural language processing project to detect genuine vs. Russian misinformation campaign tweets in the 2016 US election.</br><img width=200/>|<ul><li>99% accurate prediction model</li><li>Research report with complete findings</li></ul>|<ul><li>LSTM Neural Network</li><li>TensorFlow</li><li>Python</li><li>SQL</li></ul><img width=500/>|
